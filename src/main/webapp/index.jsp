    ...
    <body>
        ...
        <div class="container">
            <div class="course-card">
                ...
                <div class="course-desc">Master Core Java, Spring Boot, Microservices, Angular, React & more to become a job-ready full-stack developer.</div>
            ...
            <div class="course-card">
                ...
                <div class="course-desc">Learn Python, Django, REST APIs, React, and advanced deployment strategies for real-world projects.</div>
                <a href="#" class="btn">Enroll Now</a>
            </div>
            ...
            <div class="course-card">
                ...
                <div class="course-desc">Get hands-on with Docker, Kubernetes, Jenkins, Terraform & AWS Cloud to launch your DevOps career.</div>
                <a href="#" class="btn">Enroll Now</a>
            </div>
            ...
            <div class="course-card">
                ...
                <div class="course-desc">Become industry-ready with Machine Learning, Python, Deep Learning, NLP, and real-time data projects.</div>
                <a href="#" class="btn">Enroll Now</a>
            </div>
        </div>
    </body>
